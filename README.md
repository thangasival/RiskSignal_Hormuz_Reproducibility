...
This repository packages the offline analysis code, human-reviewed metadata, provenance hashes/URLs, derived physical-flow data used by the sensitivity analysis, final reports, and figures. It intentionally **does not redistribute third-party maritime advisories, insurer publications, web captures, or PDF evidence archives**.
...
- `data/manual/` — pipeline-compatible reviewed metadata and human adjudication tables.
